  ...
  return (
    <article className="group relative h-[450px] w-[360px] shrink-0 snap-start overflow-hidden rounded-2xl border border-white/15 bg-white text-slate-900 shadow-lg shadow-black/30">
      ...
      <div className="space-y-2 px-6 py-5">
        <h3 className="text-5xl font-black lowercase leading-none tracking-tight text-slate-900">{category.name}</h3>
        <p className="text-2xl font-semibold text-slate-700">{category.productCount} products available</p>
      </div>
    </article>
  );
}
